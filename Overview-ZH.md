...
到2025年年中,稳定币的流通量已突破2750亿美元,与2021年相比几乎翻倍。[^1] 随着它们走进更多消费者对企业(C2B)的支付场景,交易额同步飙升——2025年上半年稳定币相关交易约15.8万亿美元,高于2024年同期的10.3万亿美元。[^2] 这份概览从架构、平台动作以及基础设施三个角度,解释稳定币为何正在重写数字商业的结算方式。
...
稳定币是与美元等法定货币挂钩的数字代币。短短几年,它们从交易圈的辅助工具,跃升为许多人手里的"数字美元"。截至2025年中,相关市值超过2750亿美元,自2021年以来的年复合增速约65%。[^3]

背后的动力很直接:更快、更便宜、覆盖面更广,同时避开了传统加密资产的剧烈波动。如今,稳定币越来越多地出现在消费者对企业(C2B)的支付场景里:
...
稳定币正加速缩短加密世界与传统金融在支付领域的距离。曾经只服务交易员的工具,如今覆盖零售购物、内容打赏等日常场景。近期的动作——PayPal推出PYUSD、Stripe打造Tempo、Circle与Tether上线专用链——都指向对下一代支付轨道主导权的争夺。

分析师把这股竞争称为"稳定币战争", [^63][^64] 它带来的创新直接惠及消费者和企业。微额支付、实时国际工资等过去昂贵或不可行的需求,正在逐步落地。

在C2B支付里,稳定币兼具法币的熟悉感与加密网络的可编程特性。随着采用扩大,我们大概率会看到:
...
多家机构预计,随着场景扩张,稳定币市场有望在几年内突破1万亿美元。[^66] 按当前增速推算,日交易量可能很快触及2500亿美元。[^67] 再加上知名品牌的加入,数字美元正逐步成为全球商业的常规选项。
